...
#     for _,layer in reversed(model.layers.items()):
#         # print(_)
...
#         # print("analytical grad",numerical_grad_W )
#         # print("network grad", grad_W)
...
#             print("analytical grad",numerical_grad_b )
#             print("network grad", grad_b)
